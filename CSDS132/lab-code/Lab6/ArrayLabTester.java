...
public class ArrayLabTester {
    ...
    public void testArrayToString() {
        ...
        assertEquals("Return the whole string if the number requested exceeds length", "{11 13}",ArrayLab.arrayToString(a, 5)); // Test many
    }
    ...
    /**
     * Calls JUnit test on each element to verify that the first array is a prefix
     * of
     * the second array
     * 
    ...
    public void testInsert() {
        ...
        assertArrayEquals("Inserting an element that goes in the middle", new int[] { 1, 2, 3, 5, 0, 0 }, a); // Test
                                                                                                              // insert
                                                                                                              // middle
        ArrayLab.insert(a, 4, 0);
        assertArrayEquals("Inserting an element that goes in the front", new int[] { 0, 1, 2, 3, 5, 0 }, a); // Test
                                                                                                             // insert
                                                                                                             // first
        ArrayLab.insert(a, 5, 7);
        assertArrayEquals("Inserting an element that goes at the end", new int[] { 0, 1, 2, 3, 5, 7 }, a); // Test
                                                                                                           // insert
                                                                                                           // last
    }
