...
public class HW2Refactor {
    ...
    /**
     * Removes every kth word from the inputted string.
     * 
     * The purpose of this method is to take a given sentence or string as an input,
     * and remove every kth word from that input, where k is a positive integer that
     * is less than or equal to the length of the input string. The method returns
     * the modified string with every kth word removed.
     * 
    ...
    public static String removeEveryKthWord(String sentence, int k) {
        // The method only modifies the input if the k parameter is greater than 1
        // and less than or equal to the length of the input string
        if (k > 1 && k <= sentence.length()) {
            // This StringBuilder will be used to construct the modified string
            StringBuilder newString = new StringBuilder();
            // This int will be used as a counter to keep track of the number of words
            // in the modified string
            int wordCount = 1;
            // This int will be used as an index for the loop below
            int i = 0;
            ...
            while (i < sentence.length()) {
                ...
                if (sentence.charAt(i) == ' ') {
                    ...
                    // If the word count is divisible by the k parameter, skip over
                    // the next word
                    if (wordCount % k == 0) {
                        // Loop until a space is found, indicating the start of the
                        // next word
                        while (sentence.charAt(i) != ' ') {
                            i++;
                        }
                ...
                // Increment the loop index to move on to the next character
                i++;
            }
        ...
        // If the k parameter is not valid, return the original string unmodified
        return sentence;
    }
