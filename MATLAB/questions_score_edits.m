%% Note: Running this entire file will re-save question data and reset score data


%% view/edit question data
% you may change these questions to whatever you see fit. They must be
% saved in a variable named 'questions' for teh test to work. There is no
% minimum or maximum number of questions. They will be saved when this
% section is run
questions = ["Held hands romantically?";...
 "Been on a date?";...
...
writematrix(questions,'questions.csv')

%% view/edit score response data
clear;
clc;
score_outputs = ["You gotta be lying to yourself.";"That's impressive, honestly.";
    "You've seen some stuff...";"Gettin' a little freaky with it ;)";
    "You should be glad your responses aren't saved...";"I'm not sure if I should be concerned or impressed...";
    "I don't even want to know."];
writematrix(score_outputs,'score_outputs.csv')

%% clear score data
% only run this section if resetting score data is desirable
clear;
clc;
...
%% clear workspace and anything else open
clear;
clc;
close all;
